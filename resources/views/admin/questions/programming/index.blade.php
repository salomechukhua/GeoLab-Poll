	...
	<section class="wrapper">
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="full-right">
					<a class="btn btn-xs btn-success" href="{{ route('programming.create') }}">ახალი კითხვის დამატება</a>
				</div>
			</div>
		</div>
		...
		<table class="table table-bordered">
			...
			<tr>
				...
				<td>{{ $value->type }}</td>
				<td>
					<a class="btn btn-xs btn-info" href="{{ route('programming.show', $value->id) }}">ნახვა</a>
					<a class="btn btn-xs btn-primary" href="{{ route('programming.edit', $value->id) }}">რედაქტირება</a>

					{!! Form::open(['method'=> 'DELETE', 'route' => ['programming.destroy', $value->id], 'style' => 'display:inline']) !!}
