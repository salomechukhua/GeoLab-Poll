...
<section id="main-content" style="padding-left:30px;">
	<section class="wrapper">
      ...
      <div class="col-lg-12">
        <h3 class="page-header"><i class="fa fa-file-text-o"></i> პროფილის ფოტოს რედაქტირება</h3>
        <ol class="breadcrumb">
		...
		{!! Form::model($admin, ['method' => 'PATCH', 'route' => ['image.update', $admin->id],  'files' => true]) !!}
		@include('admin.pages.profile.image.form')
		{!! Form::close() !!}
